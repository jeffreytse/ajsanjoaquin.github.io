...
\begin{center}
	...
	\vspace{1mm}
	\headerpositionstyle{Trustworthy ML Researcher | MLOps | Data Scientist} \\
	\vspace{1mm}
...
\begin{cventries}
	...
	{\begin{cvitems}
		\item {Led NLP research on analyzing Transformer models' adaptability to new word definitions using few-shot learning.}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming Languages:  & {\skill{ Python, Java}} \\
		Machine Learning in Python:  & {\skill{ Pytorch, NumPy, Sickit-Learn, JAX, Keras, Tensorflow, Transformers, NLTK, Spacy}} \\
		Data:  & {\skill{ Pandas, SQL, PySpark, GPT-4, Vector Database (Qdrant, Pinecone)}} \\
