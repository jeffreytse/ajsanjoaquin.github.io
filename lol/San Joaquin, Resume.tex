...
\begin{cventries}
	\cventry
	{BSc. (Honors) in Data Science, Minor in Philosophy. \textbf{Scholarship receipient.}}
	{Yale-NUS College}
	{Singapore}
...
\begin{cventries}
	...
	{\begin{cvitems}
		\item {Pitched and led an analysis on \href{https://arxiv.org/abs/2101.04898}{Unlearnable Data} as a data protection method against ML training.}
