...
\begin{center}
	...
	\headerpositionstyle{Trustworthy ML Researcher | Data Scientist | Writer} \\
	\vspace{1mm}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		...
		Machine Learning in Python:  & {\skill{ Pytorch, NLTK, Spacy, NumPy, Sickit-Learn, Tensorflow, Keras, Jax}} \\
		Data Management:  & {\skill{ Pandas, SQL, PySpark}} \\
		Business Intelligence: & {\skill{Dash, Streamlit}} \\
		Application Deployment: & {\skill{ Kubernetes, Docker, Google Cloud, Git, Singularity}} \\
	\end{tabular}}}
	{}
	{}
	{}
