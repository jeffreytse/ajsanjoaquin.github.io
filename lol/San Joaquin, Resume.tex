...
\begin{cventries}
	...
	{\begin{cvitems}
		\item {Received a grant of $\$4500$ to attend the program.}
	...
	{\begin{cvitems}
		\item {Automated training of models on Face++ Dataset (>175,000 images). Adapted leading defences against adversarial examples (e.g. Adversarial Training, Randomized Smoothing)}.
	\end{cvitems}}
	\cventry
