...
\begin{center}
	...
	\vspace{1mm}
	\headerpositionstyle{Researcher - Trustworthy Machine Learning (Privacy, Security, Interpretability)} \\
	\vspace{1mm}
...
\begin{cventries}
	...
	{\begin{cvitems}
		...
		\item {Collaborated with Google Brain on privacy attack research for my bachelor's thesis. Resulted in a publication as the only undergraduate co-author.}
	\end{cvitems}}
	\cventry
	...
	{\begin{cvitems}
		\item {Automated training of models on Face++ Dataset (>175,000 images). Role included adapting various defences against adversarial examples (e.g. Adversarial Training, Randomized Smoothing)}
	\end{cvitems}}
	\cventry
