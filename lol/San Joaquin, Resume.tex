...
\begin{center}
	...
	\vspace{1mm}
	\headerpositionstyle{\faFlask \href{https://scholar.google.com/citations?user=e4UX388AAAAJ&hl=en}{Trustworthy ML Researcher} | MLOps | \faPencil \href{https://medium.com/@ajsanjoaquin}{Technical Writer}} \\
	\vspace{1mm}
	{\faEnvelope\ ayrton@u.yale-nus.edu.sg} | \iffalse {\faMobile\ +65 88147588} | \fi {\faMapMarker\ Singapore} | \faGithub\ \href{https://github.com/ajsanjoaquin}{ajsanjoaquin} | {\faLinkedinSquare\ \href{https://www.linkedin.com/in/ajsanjoaquin/}{ajsanjoaquin}}| {\faLink\ \href{http://ajsanjoaquin.github.io/values}{Values}}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{cventries}
	\cventry
	{BSc. (Honors) in Data Science, Minor in Philosophy. \textbf{With High Distinction (Scholarship recipient)}}
	{Yale-NUS College}
	{Singapore}
	{August 2018 - May 2023}
	{Focus: Computer Vision (CV) and Natural Language Processing (NLP). \textbf{Semester Abroad at University of Copenhagen.}}
\end{cventries}
\vspace{-3mm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Experience
...
\begin{cventries}
	...
	{\begin{cvitems}
		\item {Led an analysis on \href{https://arxiv.org/abs/2101.04898}{Unlearnable Data} as a data protection method against unauthorized Machine Learning (ML) training.}
		\item {Collaborated with Google Brain on privacy and adversarial machine learning research for my bachelor's thesis in a team across 4 time zones. \textbf{Published in a top security conference as the youngest and only undergraduate co-author.}}
	\end{cvitems}}
	\vspace{-2mm}
	\cventry
	{Researcher - Deepfake Detection}
	...
	{\begin{cvitems}
		...
		\item {Adapted various robustness strategies against adversarial noises (e.g. Adversarial Training, Randomized Smoothing)}
	\end{cvitems}}
	\vspace{-2mm}
	\cventry
	...
	{\begin{cvitems}
		\item {Created a COVID-19 Pneumonia classifier 4 days after pandemic declaration in collaboration with A.I. Singapore.}
...
\begin{cventries}
	\cventry
	{}
	{\href{https://mrecipes-ten.vercel.app/}{What's Cooking? Multilingual Recipe Search Engine}}
	{Semantic Search, NLP}
	{}
	...
	\cventry
	{}
	{\href{https://github.com/pulls?q=is\%3Apr+author\%3Aajsanjoaquin+archived\%3Afalse+is\%3Aclosed}{Open-Source AIf}}
	{DevOps}
	{}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming:  & {\skill{ Python, Java, GPT4All, Vicuna, Alpaca}} \\
		Machine Learning:  & {\skill{ Pytorch, NumPy, Sickit-Learn, JAX, Keras, Tensorflow, Transformers, NLTK, Spacy}} \\
		Data:  & {\skill{ Pandas, SQL, PySpark, Vector Database (Qdrant, Pinecone)}} \\
		MLOps: & {\skill{Docker, Git, Flask, Continuous Integration, AzureML, Kubernetes, MLFlow, Singularity}} \\
	\end{tabular}}}
	{}
	{}
	{}
